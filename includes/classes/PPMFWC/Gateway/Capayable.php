...
class PPMFWC_Gateway_Capayable extends PPMFWC_Gateway_Abstract
{
    ...
    public function init_form_fields()
    {
        ...
        $this->form_fields['ask_birthdate'] = array('title' => esc_html(__('Ask birthdate', PAYNL_WOOCOMMERCE_TEXTDOMAIN)), 'type' => 'checkbox', 'description' => esc_html(__('Ask the customer for his birthdate, this will fasten the checkout process', PAYNL_WOOCOMMERCE_TEXTDOMAIN)), 'default' => 'yes');
    ...
    public function payment_fields()
    {
        ...
        if ($ask_birthdate == 'yes') {
            echo esc_html(__('Birthdate: ', PAYNL_WOOCOMMERCE_TEXTDOMAIN)) . ' <input name="birthdate_capayble" id="birthdate_capayble"></input>';
