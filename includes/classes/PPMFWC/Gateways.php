    ...
    public static function getOrderReturnUrl(WC_Order $order, $newStatus)
    {
        ...
        } elseif ($newStatus == PPMFWC_Gateways::STATUS_DENIED)
        {
            ...
            if (!empty($methodName)) {
                ...
                wc_add_notice(esc_html(__('Unfortunately the payment has been denied by the payment method. Please try again or use another payment method.', PPMFWC_WOOCOMMERCE_TEXTDOMAIN), $methodName), 'error');
            }
